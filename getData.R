...
df <- data.frame(handNum = integer(0), BBSize = integer(0), JamesPos = character(0), JamesCard1 = character(0),
                 ...
                 comCard4 = character(0), comCard5 = character(0), Op1Name = character(0), Op1Pos = character(0), 
